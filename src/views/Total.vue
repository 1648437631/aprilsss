  ...
  <div class="content">
    ...
    <div class="order-status">
      ...
      <div class="order-repair">
        <ul>
          <li class="active">
            <router-link to="/waitpick?type=-1 ">全部</router-link>
          </li>
          <li><router-link to="/waitpick?type=-2">待付款</router-link></li>
          <li><router-link to="/waitpick?type=-0">待发货</router-link></li>
          <li><router-link to="/waitpick?type=1">运输中</router-link></li>
          <li><router-link to="/waitpick?type=2">已入库</router-link></li>
          ...
          <li><router-link to="/waitpick?type=3"></router-link> 已完成</li>
        </ul>
      </div>
    </div>
    <!-- 订单列表 -->
...
export default {
  ...
  data() {
    return {
      ...
      status:'' , //(订单状态 0：待发货；1运输中；2已入库 ;3已完成) 5已退款
    };
  },
  mounted() {
    this.init();
  ...
  methods: {
    init(type) {
      ...
      httpApi.orderApi.queryNewOrderList(data).then((res) => {
        ...
        // if (constructor this.data == []) {
        //   this.data = data;
        // } else {
        //   this.data = data.cartInfo;
